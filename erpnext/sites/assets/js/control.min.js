(function () {
	...
	frappe.ui.form.ControlCode = frappe.ui.form.ControlText.extend({
		...
		make_ace_editor: function make_ace_editor() {
			...
			var ace_editor_target = $('<div class="ace-editor-target"></div>')
	...
	// ignored /home/administrator/erpnext/apps/frappe/frappe/public/js/frappe/form/controls/quill-mention/quill.mention.css
